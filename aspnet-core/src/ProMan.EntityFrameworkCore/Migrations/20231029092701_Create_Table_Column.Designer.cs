...
namespace ProMan.Migrations
{
    ...
    [Migration("20231029092701_Create_Table_Column")]
    partial class Create_Table_Column
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProMan.Entities.ColumnStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ColumnStatuses");
                });

            modelBuilder.Entity("ProMan.Entities.CommentTicket", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ProMan.Entities.ProjectUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ProMan.Entities.Task", b =>
                {
                    ...
                    b.Property<long?>("ColumnStatusId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ProMan.Entities.Ticket", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<float?>("TimeTrackingRemaining")
                        .HasColumnType("real");

                    b.Property<float?>("TimeTrackingSpent")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ProMan.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ProMan.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ProMan.Entities.ColumnStatus", b =>
                {
                    ...
                    b.HasOne("ProMan.Entities.Ticket", "Ticket")
                        .WithMany()
            ...
            modelBuilder.Entity("ProMan.Entities.Task", b =>
                {
                    b.HasOne("ProMan.Entities.ColumnStatus", "ColumnStatus")
                        .WithMany()
                        .HasForeignKey("ColumnStatusId");
